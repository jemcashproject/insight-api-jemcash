...
BlockController.prototype.transformBlock = function (block, info) {
    ...
    return {
        ...
        reward: this.getBlockReward(info.height, block.header.isMtp()) / 1e8,
...
BlockController.prototype.getBlockReward = function (height, isMtp) {
