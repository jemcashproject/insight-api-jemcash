    ...
    describe('/tx/:txid', function () {
        it('should have correct data', function (done) {
                ...
                'vin': [
                    {
                        ...
                        'sequence': 4294967295,
                        'n': 0,
                        'addr': AddrUtils.bitcoin_address_to_jemcash('mqdofsXHpePPGBFXuwwypAqCcXi48Xhb2f'),
                        'valueSat': 18535505,
                        'value': 0.18535505,
                ...
                'vout': [
                    {
                        ...
                        'scriptPubKey': {
                            ...
                            'type': 'pubkeyhash',
                            'addresses': [
                              AddrUtils.bitcoin_address_to_jemcash('mnQ4ZaGessNgdxmWPxbTHcfx4b8R6eUr1X')
                            ]
                        },
                        'spentTxId': null,
                        'spentIndex': null,
                    ...
                    },
                    {
                        ...
                        'scriptPubKey': {
                            ...
                            'type': 'pubkeyhash',
                            'addresses': [
                              AddrUtils.bitcoin_address_to_jemcash('mqdofsXHpePPGBFXuwwypAqCcXi48Xhb2f')
                            ]
                        },
            ...
            var detailedTransaction = {
                ...
                inputs: [
                    {
                        address: AddrUtils.bitcoin_address_to_jemcash('mqdofsXHpePPGBFXuwwypAqCcXi48Xhb2f'),
                ...
                outputs: [
                    {
                        ...
                        address: AddrUtils.bitcoin_address_to_jemcash('mnQ4ZaGessNgdxmWPxbTHcfx4b8R6eUr1X')
                    },
                    {
                        address: AddrUtils.bitcoin_address_to_jemcash('mqdofsXHpePPGBFXuwwypAqCcXi48Xhb2f'),
                        satoshis: 13677426,
        ...
        it('by block hash', function (done) {
            ...
            var transactionDetails = {
                '25a988e54b02e0e5df146a0f8fa7b9db56210533a9f04bdfda5f4ceb6f77aadd': {
                    ...
                    outputs: [
                        {
                            address: AddrUtils.bitcoin_address_to_jemcash('mq4oDPjmNWnBxbzx7qouzhpCSTMePUtYDF'),
                ...
                '2e01c7a4a0e335112236b711c4aaddd02e8dc59ba2cda416e8f80ff06dddd7e1': {
                    ...
                    inputs: [
                        {
                            address: AddrUtils.bitcoin_address_to_jemcash('mgZK8zpudWoAaAwpLQSgc9t9PJJyEBpBdJ'),
                            satoshis: 990000,
                        ...
                        {
                            address: AddrUtils.bitcoin_address_to_jemcash('n4oM7bPuC4ZPdCEDvtw9xGYQC7jmi5S6F4'),
                            satoshis: 1960000,
                    ...
                    outputs: [
                        {
                            ...
                            address: AddrUtils.bitcoin_address_to_jemcash('mtVD3tdifBNujYzZ5N7PgXfKk4Bc85tDKA')
                        },
                        {
                            ...
                            address: AddrUtils.bitcoin_address_to_jemcash('mzZypShcs1B35udnkqeYeJy8rUdgHDDvKG'),
                            satoshis: 1000000
                        }
                    ]
                }
                        ...
                        'vout': [
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('mq4oDPjmNWnBxbzx7qouzhpCSTMePUtYDF')
                                    ]
                                },
                                'spentTxId': null,
                                'spentIndex': null,
                        ...
                        'vin': [
                            {
                                ...
                                'sequence': 4294967294,
                                'n': 0,
                                'addr': AddrUtils.bitcoin_address_to_jemcash('mgZK8zpudWoAaAwpLQSgc9t9PJJyEBpBdJ'),
                                'valueSat': 990000,
                                'value': 0.0099,
                                'doubleSpentTxID': null
                            },
                            {
                                ...
                                'sequence': 4294967294,
                                'n': 1,
                                'addr': AddrUtils.bitcoin_address_to_jemcash('n4oM7bPuC4ZPdCEDvtw9xGYQC7jmi5S6F4'),
                                'valueSat': 1960000,
                                'value': 0.0196,
                                'doubleSpentTxID': null
                            }
                        ...
                        'vout': [
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('mtVD3tdifBNujYzZ5N7PgXfKk4Bc85tDKA')
                                    ]
                                },
                                'spentTxId': '9a213b879da9073a9a30606f9046f35f36f268cbf03f6242993a97c4c07c00b9',
                                'spentIndex': 1,
                            ...
                            },
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('mzZypShcs1B35udnkqeYeJy8rUdgHDDvKG')
                                    ]
                                },
                                'spentTxId': '418d3eb60275957b3456b96902e908abf962e71be4c4f09486564254664951bc',
                                'spentIndex': 34,
                        ...
                        inputs: [
                            {
                                ...
                                satoshis: 2796764565,
                                address: AddrUtils.bitcoin_address_to_jemcash('msyjRQQ88MabQmyafpKCjBHUwuJ49tVjcb')
                            }
                        ],
                        outputs: [
                            {
                                satoshis: 2782729129,
                                address: AddrUtils.bitcoin_address_to_jemcash('mkPvAKZ2rar6qeG3KjBtJHHMSP1wFZH7Er'),
                            ...
                            {
                                satoshis: 14000000,
                                address: AddrUtils.bitcoin_address_to_jemcash('muHmEsjhjmATf9i3T9gHyeQoce9LXe2dWz'),
                ...
                },
                {
                    tx: {
                        ...
                        outputs: [
                            {
                                satoshis: 2764693692,
                                address: AddrUtils.bitcoin_address_to_jemcash('moSPsU4p2C2gssiniJ1JNH4fB9xs633tLv'),
                            ...
                            },
                            {
                                ...
                                address: AddrUtils.bitcoin_address_to_jemcash('mfcquSAitCkUKXaYRZTRZQDfUegnL3kDew'),
                        ...
                        'vin': [
                            {
                                ...
                                'sequence': 4294967294,
                                'n': 0,
                                'addr': AddrUtils.bitcoin_address_to_jemcash('msyjRQQ88MabQmyafpKCjBHUwuJ49tVjcb'),
                                'valueSat': 2796764565,
                                'value': 27.96764565,
                                'doubleSpentTxID': null
                            }
                        ...
                        'vout': [
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('mkPvAKZ2rar6qeG3KjBtJHHMSP1wFZH7Er')
                                    ]
                                },
                            ...
                            },
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('muHmEsjhjmATf9i3T9gHyeQoce9LXe2dWz')
                                    ]
                                },
                                'spentTxId': null,
                                'spentIndex': null,
                        ...
                        'vin': [
                            {
                                ...
                                'sequence': 4294967294,
                                'n': 0,
                                'addr': AddrUtils.bitcoin_address_to_jemcash('mkPvAKZ2rar6qeG3KjBtJHHMSP1wFZH7Er'),
                                'valueSat': 2782729129,
                                'value': 27.82729129,
                                'doubleSpentTxID': null
                            }
                        ...
                        'vout': [
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('moSPsU4p2C2gssiniJ1JNH4fB9xs633tLv')
                                    ]
                                },
                            ...
                            },
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('mfcquSAitCkUKXaYRZTRZQDfUegnL3kDew')
                                    ]
                                },
                                'spentTxId': '71a9e60c0341c9c258367f1a6d4253276f16e207bf84f41ff7412d8958a81bed',
                                'spentIndex': 0,
    ...
    describe('#transformInvTransaction', function () {
        it('should give the correct data', function () {
            var insight = {
                ...
                'vout': [
                    {
                        '425kAYrgGvZe7tp7BojBs4Y8zNoSF6QzHP': 45000
                    },
                    {
                        'a2EPJgKWBF7vifSjDWFkXoKJZxuc3Rvs75': 1993504
                    }
                ],
                'isRBF': false
            };
        ...
        it('will not include null values in vout array', function () {
            var insight = {
                ...
                'vout': [
                    {
                        'TZ6nkr18VXPjQR6CxxHdwX6XVfoyxW8ZzF': 12.5002 * 1e8
                    }
                ],
                'isRBF': false,
                'txlock': false
