...
var tx = {
    ...
    inputs: [
        {
            address: AddrUtils.bitcoin_address_to_jemcash('moFfnRwt77pApKnnU6m5uocFaa43aAYpt5'),
        ...
        {
            address: AddrUtils.bitcoin_address_to_jemcash('n1XJBAyU4hNR4xRtY3UxnmAteoJX83p5qv'),
    ...
    outputs: [
        {
            ...
            address: AddrUtils.bitcoin_address_to_jemcash('mxT2KzTUQvsaYYothDtjcdvyAdaHA9ofMp')
        },
        {
            satoshis: 53320000,
            address: AddrUtils.bitcoin_address_to_jemcash('mzkD4nmQ8ixqxySdBgsXTpgvAMK5iRZpNK'),
        ...
        {
            address: AddrUtils.bitcoin_address_to_jemcash('moZY18rGNmh4YCPeugtGW46AkkWMQttBUD'),
            satoshis: 289829,
...
describe('Addresses', function () {
    ...
    describe('/addr/:addr', function () {
        ...
        it('should have correct data', function (done) {
            var insight = {
                'addrStr': AddrUtils.bitcoin_address_to_jemcash('mkPvAKZ2rar6qeG3KjBtJHHMSP1wFZH7Er'),
                'balance': 0,
                'balanceSat': 0,
    ...
    describe('/addr/:addr/utxo', function () {
        it('should have correct data', function (done) {
            ...
            var req = {
                addr: AddrUtils.bitcoin_address_to_jemcash('mzkD4nmQ8ixqxySdBgsXTpgvAMK5iRZpNK')
            };
    ...
    describe('/addrs/:addrs/utxo', function () {
        it('should have the correct data', function (done) {
            ...
            var req = {
                addrs: "'"+AddrUtils.bitcoin_address_to_jemcash('mzkD4nmQ8ixqxySdBgsXTpgvAMK5iRZpNK')
                  +","+AddrUtils.bitcoin_address_to_jemcash('moZY18rGNmh4YCPeugtGW46AkkWMQttBUD')+"'"
            };
                        ...
                        'vin': [
                            {
                                ...
                                'sequence': 4294967295,
                                'n': 0,
                                'addr': AddrUtils.bitcoin_address_to_jemcash('moFfnRwt77pApKnnU6m5uocFaa43aAYpt5'),
                                'valueSat': 53540000,
                                'value': 0.5354,
                            ...
                            },
                            {
                                ...
                                'sequence': 4294967295,
                                'n': 1,
                                'addr': AddrUtils.bitcoin_address_to_jemcash('n1XJBAyU4hNR4xRtY3UxnmAteoJX83p5qv'),
                                'valueSat': 299829,
                                'value': 0.00299829,
                                'doubleSpentTxID': null
                            }
                        ...
                        'vout': [
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('mxT2KzTUQvsaYYothDtjcdvyAdaHA9ofMp')
                                    ]
                                },
                                'spentHeight': null,
                                'spentIndex': null,
                            ...
                            },
                            {
                                ...
                                'scriptPubKey': {
                                    ...
                                    'type': 'pubkeyhash',
                                    'addresses': [
                                      AddrUtils.bitcoin_address_to_jemcash('mzkD4nmQ8ixqxySdBgsXTpgvAMK5iRZpNK')
                                    ],
                                },
                                'spentHeight': null,
                                'spentIndex': null,
